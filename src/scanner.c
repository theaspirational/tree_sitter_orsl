...
bool tree_sitter_orsl_external_scanner_scan(void *payload, TSLexer *lexer,
...
unsigned tree_sitter_orsl_external_scanner_serialize(void *payload,
                                                       char *buffer) {
    Scanner *scanner = (Scanner *)payload;
...
void tree_sitter_orsl_external_scanner_deserialize(void *payload,
                                                     const char *buffer,
                                                     unsigned length) {
    Scanner *scanner = (Scanner *)payload;
...
void *tree_sitter_orsl_external_scanner_create() {
    ...
    tree_sitter_orsl_external_scanner_deserialize(scanner, NULL, 0);
    return scanner;
}

void tree_sitter_orsl_external_scanner_destroy(void *payload) {
    Scanner *scanner = (Scanner *)payload;
